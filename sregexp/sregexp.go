...
// Regexp is a wrapper around regexp_org.Regexp, where the underlying regexp will be
// compiled the first time it is needed.
type Regexp struct {
	str  string
	once sync.Once
	rx   *regexp_org.Regexp
}

func (r *Regexp) Regexp() *regexp_org.Regexp {
	r.once.Do(r.build)
	return r.rx
}

func (r *Regexp) build() {
	r.rx = regexp_org.MustCompile(r.str)
	r.str = ""
}
