...
// MapInt64 is a map-like data-structure for int64s
...
// NewMapInt64 returns a map initialized with n spaces and uses the stated fillFactor.
// The map will grow as needed.
func NewMapInt64(size int, fillFactor float64) *MapInt64 {
...
func (m *MapInt64) Get(key int64) (int64, bool) {
	m.RLock()
	defer m.RUnlock()
	return m.get(key)
}
...
func (m *MapInt64) shiftKeys(pos int64) int64 {
...
func (m *MapInt64) CreateKey() (k int64) {
	var ok bool
	for {
		k = int64(rand.Uint64())
		if _, ok = m.Get(k); !ok {
...
func (m *MapInt64) Keys() chan int64 {
...
func (m *MapInt64) Items() chan [2]int64 {
