...
// Package goxml provides XML services through an Element Tree
// abstraction.
package goxml
...
var ErrXML = errors.New("goxml: invalid XML format")
...
// depth level is given by the 'spaces' parameter. Pass goxml.NoIndent for
